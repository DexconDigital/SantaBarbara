    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a target="blanck" class="dropdown-item" href="https://www.simiinmobiliarias.com/base/simired/simidocs/index.php?inmo=60&tipo=2">Arrendatarios</a>
          <a target="blanck" class="dropdown-item" href="https://www.simiinmobiliarias.com/base/simired/simidocs/index.php?inmo=60&tipo=1">Propietarios</a>
      </li>
