            ...
            <div class="row">
              ...
              <div class="col-md-4 ">
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control rounded-0" id="exampleInputEmail1" required>
                </div>
              </div>
              <div class="col-md-4 ">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control rounded-0" name="telefono" id="exampleInputPassword1" required>
                </div>
              </div>
              <div class="col-md-2 ">
              </div>
              ...
              <div class="form-group col-8">
                ...
                <input type="email" name="email" class="form-control rounded-0" id="exampleInputEmail1" required>
              </div>
              <div class="col-md-2 ">
              </div>
              <div class="container-fluid ">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <textarea type="text" id="texarea_contacto" name="message" required></textarea>
                  </div>
                  <div>
                  </div>
                </div>
            ...
            <div class="row ">
              ...
              <div class=" col-12 col-lg-6 col-md-6  align-items-center justify-content-center ">
                ...
                <div class=" col-md-9 col-12 form-group">
                  <button style="padding: 4px;" type="submit" class="btn btn-dark rounded-0 col-md-12 col-12" name=""><span>Enviar</span></button>
